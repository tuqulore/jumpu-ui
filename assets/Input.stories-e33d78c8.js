import{M as y,C as s,b as a}from"./chunk-PCJTTTQV-ebdd56ef.js";import{h as t}from"./html-ce322a52.js";import{j as e}from"./jsx-runtime-76192e32.js";import{u as p}from"./index-be9ae518.js";import"./iframe-9e523eb6.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-87174ba5.js";import"./index-d475d2ea.js";import"./index-d37d4223.js";import"./index-f25de5ba.js";import"./index-356e4a49.js";const{useEffect:f}=__STORYBOOK_MODULE_CLIENT_API__,r=()=>(f(()=>{document.querySelector("#checkbox input:nth-child(3)").indeterminate=!0}),t` <div id="checkbox">
    <input
      type="checkbox"
      class="jumpu-input"
      value="checkbox-1"
  ...
  </div>`);function l(c){const n=Object.assign({h1:"h1",h2:"h2",h3:"h3"},p(),c.components);return e.jsxs(e.Fragment,{children:[e.jsx(y,{title:"Forms/Input"}),`
...
`,e.jsx(s,{children:e.jsx(a,{name:"TextIcon",children:t` <p class="mb-4">Font Awesome 5を使った例です</p>
      <div class="mt-4">
...
`,e.jsx(s,{children:e.jsx(a,{name:"Number",children:t`<input
    type="number"
    class="jumpu-input"
    placeholder="0"
  />`})}),`
`,e.jsx(n.h3,{id:"email",children:"Email"}),`
`,e.jsx(s,{children:e.jsx(a,{name:"Email",children:t`<input
      type="email"
      class="jumpu-input"
...
`,e.jsx(s,{children:e.jsx(a,{name:"File",children:t`<input type="file" class="jumpu-input" />`})})]})}function k(c={}){const{wrapper:n}=Object.assign({},p(),c.components);return n?e.jsx(n,{...c,children:e.jsx(l,{...c})}):l(c)}const u=()=>t`<input type="text" class="jumpu-input" placeholder="名前" />`;u.storyName="Text";u.parameters={storySource:{source:'html`<input type="text" class="jumpu-input" placeholder="名前" />`'}};const o=()=>t` <p class="mb-4">Font Awesome 5を使った例です</p>
      <div class="mt-4">
        <label class="mb-1 block" for="search-input"
          ><i class="fas fa-search"></i> 検索</label
        >
      ...
      <div class="mt-4">
        ...
        <input
          ...
          id="search-email"
        />
      </div>`;o.storyName="TextIcon";o.parameters={storySource:{source:`html\` <p class="mb-4">Font Awesome 5を使った例です</p>
      <div class="mt-4">
        <label class="mb-1 block" for="search-input"
          ><i class="fas fa-search"></i> 検索</label
        >
    ...
    class="jumpu-input"
    placeholder="0"
  />`;m.storyName="Number";m.parameters={storySource:{source:`html\`<input
    type="number"
    class="jumpu-input"
    placeholder="0"
  />\``}};const d=()=>t`<input
      ...
      class="jumpu-input"
      placeholder="example@hoge.com"
    />`;d.storyName="Email";d.parameters={storySource:{source:`html\`<input
      type="email"
      class="jumpu-input"
      placeholder="example@hoge.com"
...
//# sourceMappingURL=Input.stories-e33d78c8.js.map
